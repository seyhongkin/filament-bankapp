<div
    class="w-96 h-56 m-auto bg-gradient-to-r from-violet-600 to-indigo-600 rounded-xl relative text-white shadow-2xl transition-transform transform hover:scale-110">
