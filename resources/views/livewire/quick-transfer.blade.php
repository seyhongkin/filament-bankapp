<div class="border rounded-xl p-4">
    ...
    <div class="flex mt-8 mb-2 gap-8 overflow-x-auto">
        @for ($i = 0; $i < 3; $i++)
            <div class="text-sm flex flex-col items-center space-y-1 min-w-18">
                <img class="h-16 w-16 rounded-full object-cover"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREO17hg6KvLlweeZWN0LCEdi-OXM9qGpbQ9w&s"
                    alt="picture">
                <div class="text-center">
                    <p class="font-bold">Livia Bactor</p>
                    <p>CEO</p>
                </div>
            </div>
        @endfor
    ...
    <div class="flex items-center gap-2">
        <p class="text-gray-500 w-1/3">Write amount</p>
        <input type="text" class="border-0 rounded-full bg-gray-200 w-1/3" placeholder="0.00">

        <button class="border rounded-full flex items-center px-4 gap-4 py-2 w-1/3">
            Send
